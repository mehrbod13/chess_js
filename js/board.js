...
export class Board {
    ...
    selectPiece(piece) {
        ...
        for (let move of piece.getValidMoves()) {
            ...
            let square = document.querySelector(`.square:nth-child(${move.col * 8 + move.row + 1})`);
            if (square) {
                square === null || square === void 0 ? void 0 : square.addEventListener("click", () => this.moveListener(move.col, move.row));
            }
        }
    }
    moveListener(col, row) {
    ...
    highlightSquare(col, row) {
        let square = document.querySelector(`.square:nth-child(${col * 8 + row + 1})`);
        square === null || square === void 0 ? void 0 : square.classList.add("highlighted");
    }
}
